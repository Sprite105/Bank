...
class srcDevDebugProjectContainerUrlGenerator extends Symfony\Component\Routing\Generator\UrlGenerator
{
    ...
    public function __construct(RequestContext $context, LoggerInterface $logger = null, string $defaultLocale = null)
    {
        ...
        'app_api_customer_create' => array(array(), array('_controller' => 'App\\Controller\\Api\\CustomerController::create'), array(), array(array('text', '/api/customers/create')), array(), array()),
        'app_api_transaction_index' => array(array(), array('_controller' => 'App\\Controller\\Api\\TransactionController::index'), array(), array(array('text', '/api/transactions')), array(), array()),
        'app_api_transaction_getone' => array(array('customer', 'transaction'), array('_controller' => 'App\\Controller\\Api\\TransactionController::getOne'), array(), array(array('variable', '/', '[^/]++', 'transaction'), array('variable', '/', '[^/]++', 'customer'), array('text', '/api/transactions')), array(), array()),
        'app_api_transaction_create' => array(array(), array('_controller' => 'App\\Controller\\Api\\TransactionController::create'), array(), array(array('text', '/api/transactions/create')), array(), array()),
        'app_api_transaction_update' => array(array('transaction'), array('_controller' => 'App\\Controller\\Api\\TransactionController::update'), array(), array(array('variable', '/', '[^/]++', 'transaction'), array('text', '/api/transactions')), array(), array()),
        'app_api_transaction_delete' => array(array('transaction'), array('_controller' => 'App\\Controller\\Api\\TransactionController::delete'), array(), array(array('variable', '/', '[^/]++', 'transaction'), array('text', '/api/transactions')), array(), array()),
        'dashboard' => array(array(), array('_controller' => 'App\\Controller\\DashboardController::index'), array(), array(array('text', '/')), array(), array()),
