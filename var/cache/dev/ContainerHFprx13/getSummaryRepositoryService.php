...
// Returns the private 'App\Repository\SummaryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SummaryRepository.php';

return $this->privates['App\Repository\SummaryRepository'] = new \App\Repository\SummaryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
